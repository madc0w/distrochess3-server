export const en = {
	emails: {
		autoResign: {
			...
			greeting: 'Hi {name},',
			body: "If you (or another player on your side) doesn't make a move within the next {hours} hours, your side will forfeit the game. This means your side will be resigning, and you will lose points, resulting in sad ducks.",
			description:
